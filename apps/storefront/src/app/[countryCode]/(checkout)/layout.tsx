import { getIntlConfig, getTranslator } from "@i18n/get-messages"
...
export default async function CheckoutLayout({
  ...
  return (
    <div lang={locale} className="w-full bg-white relative small:min-h-screen">
      <StorefrontIntlProvider locale={locale} messages={messages}>
        ...
        <div className="py-4 w-full flex items-center justify-center">
          <MedusaCTA countryCode={countryCode} />
        </div>
