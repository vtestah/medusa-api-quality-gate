...
const Overview = async ({ customer, orders }: OverviewProps) => {
  ...
  const tNav = await getTranslations("AccountNav")
      ...
      <div className="hidden small:block">
        <div className="text-xl-semi flex justify-between items-center mb-4">
          <span data-testid="welcome-message" data-value={customer?.first_name}>
            {tNav("hello")} {customer?.first_name}
          </span>
          ...
          <div className="flex flex-col gap-y-4 h-full col-span-1 row-span-2 flex-1">
            <div className="flex items-start gap-x-16 mb-6">
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">{tNav("profile")}</h3>
              ...
              <div className="flex flex-col gap-y-4">
                <h3 className="text-large-semi">{tNav("addresses")}</h3>
                <div className="flex items-end gap-x-2">
                  <span
                    className="text-3xl-semi leading-none"
